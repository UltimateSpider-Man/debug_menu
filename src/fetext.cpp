...
FEText::FEText(font_index a2,
               ...
               int a10,
               color32 a11) {
    CDECL_CALL(0x00617500, this, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);
}


    void FEText::SetShown(bool a2)
{
...
void FEText_patch() {
    {
        auto address = func_address(&FEText::_unmash);
        SET_JUMP(0x0062E540, address);
    }

    {
        auto address = func_address(&FEText::_get_mash_sizeof);
        set_vfunc(0x0087A02C, address);
    }

    {
        auto address = func_address(&FEText::SetTextNoLocalize);
    ...
    if constexpr (0) {
        {
            auto address = func_address(&FEText::Update);
            SET_JUMP(0x006098D0, address);
        }

        {
            auto address = func_address(&FEText::Draw);
        ...
        {
            auto address = func_address(&FEText::AdjustForJustification);
