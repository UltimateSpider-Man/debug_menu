...
inline int& scan_pos = var<int>(0x009684F8);
inline char*& line = var<char*>(0x009684FC);
inline char& token = var<char>(0x009683F8);
inline char& stored_token = var<char>(0x00968500);
inline char& stored_type = var<char>(0x00968501);
inline char& stored_num = var<char>(0x00968502);

    inline auto& filename = var<char[255]>(0x009682F8);



inline void new_line(char* lpBuffer)
{
    line = lpBuffer;
    scan_pos = 0;
}

inline signed int build_token(char* a1, char* a2)
{
    char* v2 = a1;
    char v3 = *a1;
    signed int result = 0;
...
inline int get_token(char** a1, int* a2, int* a3)
{
    int result;
    char* v4;
    int v5;
...
inline void parse(const char* ini_filename, os_developer_options* a2)
{
    if constexpr (1) {
