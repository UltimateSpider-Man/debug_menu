...
inline void nglGetStringDimensions_console(nglFont* Font, uint32_t* a2, uint32_t* a3, const char* a4)
{
    CDECL_CALL(0x007798E0, Font, a2, a3, a4);
}
...
inline void nglListInit()
{
    ...
    if constexpr (1) {
        ...
        if (nglSyncDebug().DrawMeshSpheres) {
            nglDebug().DrawMeshSpheres = 1;
        }
        if (nglSyncDebug().DisableDuplicateMaterialWarning) {
            nglDebug().DisableDuplicateMaterialWarning = 1;
        }
        if (nglSyncDebug().DisableMissingTextureWarning) {
            nglDebug().DisableMissingTextureWarning = 1;
        }
