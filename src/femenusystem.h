...
inline    void UpdateButtonDown(){
    ...
    //0x0060B610
    //virtual
    inline void MakeActive(int idx)
    {
    }

    //virtual
 inline char GetDefaultColorScheme()
 {
 }

    //virtual
  inline bool GetSingleInput()
  {
    ...
    //0x006187D0
    //virtual
  inline  void OnButtonPress(int a2, int a3){
    ...
    //0x0060B6B0
    //virtual
inline    void OnButtonRelease(int a2, int a3){
    ...
    //0x006298D0
    //virtual
 inline   void UpdateButtonPresses(){
