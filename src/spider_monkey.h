...
namespace spider_monkey
{
    ...
    inline void debug_menu_enabled()
    {
    ...
    inline void render(debug_menu_entry* a1)
    {
...

        {
            ...
            {
                warning("Could not find token resource %s");
            }


            if (os_developer_options::instance()->get_flag(mString{ "WAIT_FOR_LINK" }))
            {
                g_game_ptr()->advance_state_wait_link(1.0);
            }
            ...
            {
                auto v40 = (g_game_ptr()->field_278 == 0 ? 0.f : (0.64f / g_game_ptr()->field_278));
                auto v39 = (
                        ((g_game_ptr()->field_278 - g_game_ptr()->field_27C) - g_game_ptr()->field_280) >= 0.000099999997
                        ? (0.64 / (g_game_ptr()->field_278 - g_game_ptr()->field_27C - g_game_ptr()->field_280))
                        : 3000.0f);
