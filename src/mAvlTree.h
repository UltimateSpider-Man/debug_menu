...
struct mAvlTree  {
  ...
  inline int* sub_64A090(int* a2)
    {
      void(__fastcall * func)(void*, void*, int) = (decltype(func))0x0064A090;
    ...
    inline void sub_64A2B0()
  {
        void(__fastcall * func)(void*, void*) = (decltype(func))0x0064A2B0;
        func(this, nullptr);
      }
