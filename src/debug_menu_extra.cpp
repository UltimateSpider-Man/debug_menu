...
void populate_district_variants_menu(debug_menu_entry *entry)
{
    ...
    debug_menu_entry v4;
    debug_menu_entry* block3 = v4.alloc_block(v5, 4);
    block3[0] = debug_menu_entry { v5 };
...
void populate_warp_menu(debug_menu_entry *entry)
{
    ...
    debug_menu_entry v4;
    debug_menu_entry* block3 = v4.alloc_block(v20, 4);
    block3[0] = debug_menu_entry { v20 };
...
void create_ngl_menu(debug_menu *parent)
{
    ...
    debug_menu_entry v4;
    debug_menu_entry* block3 = v4.alloc_block(v22, 4);
...
void create_debug_render_menu(debug_menu *parent)
{
    ...
    parent->add_entry(v4);
    debug_menu_entry v5;
    debug_menu_entry* block3 = v5.alloc_block(debug_render_menu, 4);
    block3[0] = debug_menu_entry { debug_render_menu };
...
void populate_variants_menu(debug_menu_entry* entry)
{
    ...
    debug_menu_entry v4;
    debug_menu_entry* block3 = v4.alloc_block(menu, 4);
    block3[0] = debug_menu_entry { menu };
...
void populate_entity_variants_menu(debug_menu_entry* entry)
{
    ...
    debug_menu_entry v5;
    debug_menu_entry* block3 = v5.alloc_block(submenu, 4);
    block3[0] = debug_menu_entry { submenu };
...
void populate_dvars(debug_menu_entry* entry)
{
    ...
    entry->set_submenu(v7);
        ...
        debug_menu_entry v50;
    debug_menu_entry* block3 = v50.alloc_block(v7, 4);
    block3[0] = debug_menu_entry { v7 };
...
void populate_replay_menu(debug_menu_entry* entry)
{
    ...
    debug_menu_entry v5;
    debug_menu_entry* block3 = v5.alloc_block(head_menu, 4);
    block3[0] = debug_menu_entry { head_menu };
